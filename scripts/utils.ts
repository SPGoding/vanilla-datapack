...
export const GeneratedDefaultNamespacePath = path.join(GeneratedDataPath, 'minecraft')
export const GeneratedDimensionPath = path.join(GeneratedDefaultNamespacePath, 'dimension')
export const GeneratedDimensionTypePath = path.join(GeneratedDefaultNamespacePath, 'dimension_type')
export const GeneratedWorldgenPath = path.join(GeneratedDefaultNamespacePath, 'worldgen')
...
export const DataGeneratorGeneratedDirName = 'data_generator_generated'
export const DataGeneratorGeneratedWorldgenRoot = path.join(InputPath, DataGeneratorGeneratedDirName, 'reports', 'worldgen', 'minecraft')
export const DataGeneratorGeneratedDimensionPath = path.join(DataGeneratorGeneratedWorldgenRoot, 'dimension')
export const DataGeneratorGeneratedDimensionTypePath = path.join(DataGeneratorGeneratedWorldgenRoot, 'dimension_type')
export const DataGeneratorGeneratedWorldgenPath = path.join(DataGeneratorGeneratedWorldgenRoot, 'worldgen')
